...
function cadastrarDespesas (){
    ...
    if(despesa.validarDados()){
        ...
        document.getElementById('modal_titulo').innerHTML = 'Tudo Certo!'
        document.getElementById('modal_descricao').innerHTML = 'Cadastro feito com sucesso!'
        ...
        document.getElementById('modal_titulo').innerHTML = 'Ops... Ocorreu um erro!'
        document.getElementById('modal_descricao').innerHTML = 'Confira os campos que não foram preenchidos.'
